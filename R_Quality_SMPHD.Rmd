...
```
## Le fichier analysé est `r name` pour le patient `r patient`. L'utilisateur `r params$user` a lancé le pipeline de routine `r params$pipeline` verstion test 3.2.
