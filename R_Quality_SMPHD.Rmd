...
```
## Le fichier analysé est `r name` pour le patient `r patient`. L'utilisateur `r params$user` a lancé le pipeline de routine `r params$pipeline` verstion 3.3 validé le 28/01/2021.
...
#write(paste("Patient","Couv >200x","Mediane","%in-target",sep=";"), params$output,append=TRUE)
write(paste(patient,X200b,median,params$ratio_library,sep=";"), params$output,append=TRUE)
...
* Ratio library in target = `r params$ratio_library` %
